...
LOG="$PHASE_ROOT/g6_rank1_full_angle_only_bounded8192_b1.log"
PID_FILE="$PHASE_ROOT/g6_rank1_full_angle_only_bounded8192_b1.pid"
...
nohup bash scripts/phase70_run_rank1_full_angle_only_bounded8192_b1.sh > "$LOG" 2>&1 &
PID="$!"
echo "$PID" > "$PID_FILE"
